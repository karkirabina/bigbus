...
<script>
    $(document).ready(function() {
        ...
        $('#manage_schedule').submit(function(e) {
            ...
            start_load(); // Start loading indicator or show loading message
            ...
            $.ajax({
                ...
                error: function(err) {
                    console.log(err);
                    end_load(); // Stop loading indicator or hide loading message
                    alert_toast('An error occurred', 'danger'); // Show error message
                },
                success: function(resp) {
                    if (resp == 1) {
                        ...
                        load_schedule(); // Function to load and update the schedule
                    }
                }
            });
        });

        // Configure datetimepicker plugin
